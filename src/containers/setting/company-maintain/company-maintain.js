...
class CompanyMaintain extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      columns: [
        {          /*公司代码*/
          title: this.props.intl.formatMessage({id:"company.companyCode"}), key: "companyCode", dataIndex: 'companyCode'
        },
        {          /*公司类型*/
          title: this.props.intl.formatMessage({id:"company.companyType"}), key: "companyType", dataIndex: 'companyType'
        },
        {          /*公司名称*/
          title: this.props.intl.formatMessage({id:"company.name"}), key: "name", dataIndex: 'name',
        },
        {          /*账套*/
          title: this.props.intl.formatMessage({id:"company.setOfBooksName"}), key: "setOfBooksName", dataIndex: 'setOfBooksName'
        },
        {          /*法人*/
          title: this.props.intl.formatMessage({id:"company.legalEntityName"}), key: "legalEntityName", dataIndex: 'legalEntityName',

        },
        {          /*公司级别*/
          title: this.props.intl.formatMessage({id:"company.companyLevelName"}), key: "companyLevelName", dataIndex: 'companyLevelName',
        },
        {          /*上级机构*/
          title: this.props.intl.formatMessage({id:"company.parentCompanyName"}), key: "parentCompanyName", dataIndex: 'parentCompanyName',
        },
        {          /*有效日期从*/
          title: this.props.intl.formatMessage({id:"company.startDateActive"}), key: "startDateActive", dataIndex: 'startDateActive',
        },
        {          /*有效日期至*/
          title: this.props.intl.formatMessage({id:"company.endDateActive"}), key: "endDateActive", dataIndex: 'endDateActive',
        }
      ],
  ...
  HandleRowClick=(value)=>{
      let path=this.state.companyMaintainDetailPage.url.required(":companyCode",value.companyCode);
      this.context.router.push(path);
  }
