    ...
    this.state = {
      ...
      columnGroup: {
        ...
        dimension: [
          ...
          {
            /*默认维值*/
            title: formatMessage({id: "structure.defaultDimValueName"}),
    ...
    return (
      <div className="budget-structure-detail">
        ...
        <div className="table-header">
          <div
            className="table-header-title">{this.props.intl.formatMessage({id: 'common.total'}, {total: `${total}`})}</div>
          {/*共搜索到*条数据*/}
          <div className="table-header-buttons">
            <Button type="primary"
                    onClick={this.handleCreate}>{status === 'user' ? this.props.intl.formatMessage({id: 'structure.addCompany'}) :
