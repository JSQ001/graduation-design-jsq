...
class SelectContract extends React.Component {
    ...
    getList() {
        ...
        let url = `http://rjfin.haasgz.hand-china.com:30498/contract/api/contract/line/associate/query?companyId=138&partnerCategory=EMPLOYEE&partnerId=911143733222408193`;
